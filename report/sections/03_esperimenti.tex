...
\begin{sidewaystable}
    \footnotesize
    \caption{Numero di iterazioni per la convergenza dei diversi metodi sui problemi di benchmark, sia in assenza che in presenza di rumore.}\label{tab:iterazioni}
    \centering
    \begin{tabular}{lccccccc}
    \toprule
    \multirow{2}{*}{\textbf{Problema}} & \textbf{GD} & \textbf{GD} & \textbf{BFGS} & \textbf{BFGS} & \textbf{SciPy BFGS} & \textbf{SciPy BFGS} & \textbf{BFGS Tollerante} \\
                                       & (no rumore) & (con rumore) & (no rumore) & (con rumore) & (no rumore) & (con rumore) & (con rumore) \\
    \midrule
