...
\begin{figure}
    ...
    \caption{Andamento della funzione obiettivo e della norma del gradiente per i diversi metodi su BOXPOWER con rumore di piccola entità (\(10^{-8}\)).}
\end{figure}
...
\begin{figure}
    ...
    \caption{Andamento della funzione obiettivo e della norma del gradiente per i diversi metodi su BOXPOWER con rumore di grande entità (\(10^{-5}\)).}
\end{figure}